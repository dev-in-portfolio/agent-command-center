...
def generate_route_id(command: str, route_label: str, index: int, runtime_version: str = "1.8.0") -> str:
    ...
    return f"route-v1-8-{normalized_label}-{index:03d}-{hash_chars}"

def create_department_routing_schema() -> dict:
    return {
        "department_routing_schema_version": "1.8.0",
