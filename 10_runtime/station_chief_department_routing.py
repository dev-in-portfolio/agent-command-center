...
def generate_route_id(command: str, route_label: str, index: int, runtime_version: str = "2.4.0") -> str:
    ...
    return f"route-v2-4-{normalized_label}-{index:03d}-{hash_chars}"

def create_department_routing_schema() -> dict:
    return {
        "department_routing_schema_version": "2.4.0",
