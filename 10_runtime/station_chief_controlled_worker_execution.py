...
CONTROLLED_WORKER_EXECUTION_MODULE_VERSION = "2.1.0"
...
def generate_worker_execution_run_id(command: str, worker_id: str, runtime_version: str = "2.1.0") -> str:
    ...
    return f"controlled-worker-v2-1-{normalized_worker_id}-{hash_chars}"

def create_controlled_worker_execution_schema() -> dict:
    return {
        "controlled_worker_execution_schema_version": "2.1.0",
...
def create_worker_execution_gate(
    ...
    return {
        "worker_execution_gate_version": "2.1.0",
        "gate_status": status,
        "command": command,
        "worker_id": w_id,
...
def create_tool_permission_binding(
    ...
    return {
        "tool_permission_binding_version": "2.1.0",
        "worker_id": worker_id,
...
def create_sandbox_worker_task(
    ...
    p = payload or {}
    return {
        "sandbox_worker_task_version": "2.1.0",
...
def create_worker_abort_contract(worker_id: str, worker_run_id: str | None = None) -> dict:
    return {
        "worker_abort_contract_version": "2.1.0",
        "worker_id": worker_id,
...
def create_worker_rollback_contract(worker_id: str, worker_run_id: str | None = None) -> dict:
    return {
        "worker_rollback_contract_version": "2.1.0",
        "worker_id": worker_id,
        "worker_run_id": worker_run_id,
...
def create_worker_execution_telemetry_stub(worker_id: str, worker_run_id: str | None = None) -> dict:
    return {
        "worker_execution_telemetry_stub_version": "2.1.0",
        "worker_id": worker_id,
        "worker_run_id": worker_run_id,
...
def run_single_worker_sandbox_task(
    ...
    if not (authorized and perms_pass and task in allowed_tasks):
        return {
            "controlled_worker_execution_result_version": "2.1.0",
            "worker_run_id": None,
...
def create_post_run_audit_proof(
    ...
    return {
        "post_run_audit_proof_version": "2.1.0",
...
def create_worker_execution_ledger(
    ...
    return {
        "worker_execution_ledger_version": "2.1.0",
...
def create_single_worker_tool_permission_binding_readiness_bridge(
    ...
    return {
        "single_worker_tool_permission_binding_readiness_bridge_version": "2.1.0",
...
def create_controlled_worker_execution_bundle(
    ...
    return {
        "controlled_worker_execution_bundle_version": "2.1.0",
        "controlled_worker_execution_status": "SINGLE_WORKER_SANDBOX_EXECUTION_ONLY",
