...
def generate_worker_id(command: str, role_label: str, index: int, runtime_version: str = "2.0.0") -> str:
    ...
    return f"worker-v2-0-{normalized_label}-{index:03d}-{hash_chars}"

def create_worker_role_schema() -> dict:
    return {
        "worker_role_schema_version": "2.0.0",
