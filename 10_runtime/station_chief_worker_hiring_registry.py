...
def generate_worker_id(command: str, role_label: str, index: int, runtime_version: str = "1.8.0") -> str:
    ...
    return f"worker-v1-8-{normalized_label}-{index:03d}-{hash_chars}"

def create_worker_role_schema() -> dict:
    return {
        "worker_role_schema_version": "1.8.0",
