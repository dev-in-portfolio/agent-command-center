...
LIVE_EXECUTION_TELEMETRY_ABORT_MODULE_VERSION = "2.5.0"
...
def generate_telemetry_abort_id(command: str, worker_id: str, runtime_version: str = "2.5.0") -> str:
    ...
    return f"telemetry-abort-v2-5-{normalized_worker_id}-{hash_chars}"

def create_live_execution_telemetry_abort_schema() -> dict:
    return {
        "live_execution_telemetry_abort_schema_version": "2.5.0",
...
def create_telemetry_event_schema() -> dict:
    return {
        "telemetry_event_schema_version": "2.5.0",
...
def create_execution_state_model(
    ...
    return {
        "execution_state_model_version": "2.5.0",
        "worker_id": worker_id,
        "command": command,
        "state": state,
...
def create_telemetry_approval_gate(
    ...
    return {
        "telemetry_approval_gate_version": "2.5.0",
        "worker_id": worker_id,
        "gate_status": status,
...
def create_abort_signal_contract(
    ...
    return {
        "abort_signal_contract_version": "2.5.0",
        "worker_id": worker_id,
...
def create_timeout_contract(
    ...
    return {
        "timeout_contract_version": "2.5.0",
        "worker_id": worker_id,
        "contract_status": status,
...
def create_partial_result_capture(
    ...
    return {
        "partial_result_capture_version": "2.5.0",
        "worker_id": worker_id,
...
def create_failed_run_quarantine_contract(
    ...
    return {
        "failed_run_quarantine_contract_version": "2.5.0",
        "worker_id": worker_id,
...
def create_post_abort_audit_proof(
    ...
    return {
        "post_abort_audit_proof_version": "2.5.0",
        "worker_id": worker_id,
...
def create_telemetry_ledger(
    ...
    return {
        "telemetry_ledger_version": "2.5.0",
...
def create_telemetry_readiness_summary(
    ...
    return {
        "telemetry_readiness_summary_version": "2.5.0",
        "worker_id": worker_id,
...
def create_post_run_audit_expansion_readiness_bridge(
    ...
    return {
        "post_run_audit_expansion_readiness_bridge_version": "2.5.0",
...
def create_live_execution_telemetry_abort_bundle(
    ...
    return {
        "live_execution_telemetry_abort_bundle_version": "2.5.0",
        "live_execution_telemetry_abort_status": "SINGLE_WORKER_TELEMETRY_ABORT_CONTROLS_ONLY",
