...
SPEC_PATH = '04_workflow_templates/family_expansion_batch_075_084.json'

HARDCODED_STRINGS = [
    "Creativity, Ideation & Concept Generation",
    "Cross-Domain Inspiration",
    "Creative Risk Review",
    "Decision Memory & Lessons Learned",
    "Regret And Error Review",
    "Decision Pattern Library",
    "Environmental Scanning & Opportunity Radar",
    "Regulatory Horizon Scan",
    "Opportunity Prioritization",
    "Standards of Evidence & Source Hierarchy",
    "Conflicting Evidence Review",
    "Claim Confidence Scoring",
    "User Experience Research & Human Factors",
    "Human Factors Review",
    "UX Insight Synthesis",
    "Experimental Governance & Sandbox Control",
    "Stop Conditions",
    "Experimental Governance Board",
    "Agent Memory Governance & Recall Control",
    "Cross-Thread Recall Control",
    "Memory Governance Dashboard",
    "Version Control, Releases & Change Management",
    "Branch And Merge Review",
    "Rollback Planning",
    "API Economy, Platform Access & Usage Limits",
    "Rate Limit Management",
    "Free Tier Optimization",
    "Infrastructure Economics & Compute Planning",
    "Local Versus Cloud Compute",
    "Infrastructure Economics Dashboard"
]
...
def validate():
    ...
    if errors:
        ...
        print("PASS: Family batch 075-084 expansion valid.")
        sys.exit(0)
