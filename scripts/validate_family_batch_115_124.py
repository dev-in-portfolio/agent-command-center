...
def validate_batch():
    spec_path = "04_workflow_templates/family_expansion_batch_115_124.json"
    with open(spec_path, 'r') as f:
        batch_spec = json.load(f)

    required_strings = [
        "Platform Strategy & Distribution Channels",
        ...
        "Synonym And Variant Control",
        "Controlled Vocabulary",
        "Knowledge Graph & Relationship Mapping",
        "Edge Relationship Design",
        "Relationship Inference",
        "Data Pipelines & ETL Operations",
        "Pipeline Failure Recovery",
        "Search, Discovery & Retrieval Operations",
        "Retrieval Augmentation",
        "Search Failure Recovery",
        "Data Labeling, Annotation & Training Sets",
        "Disagreement Resolution",
        "Bias And Coverage Review",
        "Personal Data Rooms & Secure Project Spaces",
        "Data Room Audit Trail",
        "Secure Space Dashboard",
        "Identity, Access & Permission Architecture",
        "Role-Based Access Control",
        "Least Privilege Review",
        "Data Privacy, Consent & Retention Operations",
        "Data Subject Request Support",
        "Consent And Retention Summary"
    ]
    ...
    for family_spec in batch_spec:
        ...
        family_dir = os.path.join("02_departments", f"{family_id_str}_{folder_name}")
    ...
    if errors:
        ...
        print("PASS: Family batch 115-124 expansion valid.")
