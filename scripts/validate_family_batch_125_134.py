...
def validate_batch():
    spec_path = "04_workflow_templates/family_expansion_batch_125_134.json"
    ...
    required_strings = [
        ...
        "Acceptance Evidence",
        "Agent Observability, Telemetry & Run Analytics",
        "Agent Behavior Analytics",
        "Observability Dashboard",
        "State Management & Workflow Memory",
        "Workflow Memory Capture",
        "State Conflict Resolution",
        "Work Product Governance & Deliverable Standards",
        "Versioned Deliverable Control",
        "Delivery Readiness",
        "Knowledge Quality, Currency & Source Freshness",
        ...
        "Approval UX, Review Queues & Human Control",
        "Human Control Points",
        "Approval SLA Tracking",
        "Agent Marketplace, Templates & Reusable Crews",
        "Reusable Crew Design",
        "Agent Template Versioning",
        "Agent Conversation Memory & Internal Messaging",
        "Conversation Context Bridging",
        "Internal Messaging Norms",
        "External Action Governance",
        "External Tool Action Approval",
    ...
    if errors:
        ...
        print("PASS: Family batch 125-134 expansion valid.")
