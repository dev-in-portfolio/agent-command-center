...
def apply_batch():
    ...
    for family_spec in batch_spec:
        ...
        # Determine folder name based on naming convention
        folder_name = "175_master_archive_library_of_alexandria"
        family_dir = os.path.join("02_departments", folder_name)
