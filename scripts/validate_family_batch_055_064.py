...
SPEC_PATH = '04_workflow_templates/family_expansion_batch_055_064.json'

HARDCODED_STRINGS = [
    "Agent Society & Internal Culture",
    "Agent Conflict Mediation",
    "Internal Culture Archive",
    "Autonomous Operations Control",
    "Human Override Handling",
    "Autonomy Governance",
    "Multi-Agent Orchestration & Swarm Control",
    "Inter-Agent Messaging",
    "Parallel Work Management",
    "Tool Operations & External Access",
    "Browser And Web Tool Operations",
    "File And Connector Operations",
    "Interface, Dashboard & Control Panels",
    "Workflow Map Displays",
    "Configuration Panels",
    "Experimental Systems & Weird Lab",
    "Impossible Systems",
    "Weird Lab Safety",
    "Archives, Museums & Collection Management",
    "Provenance Tracking",
    "Loan And Access Management",
    "Scientific Research & Lab Operations",
    "Replication And Validation",
    "Investor Research & Market Intelligence",
    "Trade Thesis Support",
    "Relationship Intelligence & Network Management",
...
def validate():
    ...
    for family in spec['families']:
        ...
        if len(depts) != len(family['departments']):
            errors.append(f"Dept count mismatch in {family_json_path}: expected {len(family['departments'])}, got {len(depts)}")
    ...
    if errors:
        ...
        print("PASS: Family batch 055-064 expansion valid.")
        sys.exit(0)
