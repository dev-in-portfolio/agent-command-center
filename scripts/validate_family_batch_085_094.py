...
SPEC_PATH = '04_workflow_templates/family_expansion_batch_085_094.json'

HARDCODED_STRINGS = [
    "Agent Procurement, Hiring & Role Marketplace",
    "Agent Trial Assignment",
    "Agent Bench Management",
    "Agent Labor Relations & Internal Governance",
    "Agent Dispute Resolution",
    "Agent Council Operations",
    "Emotional Brand Experience & Client Perception",
    "Client Anxiety Reduction",
    "Emotional Brand Dashboard",
    "Strategic Memory, Institutional Knowledge & Lore",
    "Organizational Memory Map",
    "Lore Governance",
    "Narrative Intelligence & Explanation Design",
    "Audience-Specific Translation",
    "Narrative Evidence Integration",
    "Meta-Reasoning & Cognitive Control",
    "Reasoning Mode Switching",
    "Confidence Calibration",
    "Multi-Modal Intelligence & Artifact Understanding",
    "Mixed Artifact Synthesis",
    "Artifact Quality Review",
    "Data Visualization & Information Design",
    "Visual Encoding Review",
    "Visualization Accessibility",
    "Conversation Design & Dialogue Systems",
...
def validate():
    ...
    for family_spec in spec['families']:
        ...
        if len(depts) != len(family_spec['departments']):
            errors.append(f"Dept count mismatch in {family_json_path}: expected {len(family_spec['departments'])}, got {len(depts)}")
    ...
    if errors:
        ...
        print("PASS: Family batch 085-094 expansion valid.")
        sys.exit(0)
