...
SPEC_PATH = '04_workflow_templates/family_expansion_batch_065_074.json'

HARDCODED_STRINGS = [
    "Legal Operations & Case Management",
    "Legal Matter Intake",
    "Legal Timeline Building",
    "Investigations & Due Diligence",
    "Due Diligence Review",
    "Source Credibility Review",
    "Personal Finance, Tax & Household Economy",
    "Personal Tax Organization",
    "Household Economic Planning",
    "Travel, Field Work & Mobility Operations",
    "Field Work Preparation",
    "Mobility Logistics",
    "Home, Workshop & Physical Project Builds",
    "Vendor And Contractor Coordination",
    "Physical Build Archive",
    "Humor, Entertainment & Engagement Systems",
    "Comedy Risk Review",
    "Fun Facts And Trivia",
    "Spiritual, Philosophical & Meaning Systems",
    "Symbol And Archetype Mapping",
    "Belief System Mapping",
    "Emotional Intelligence & Self-Regulation Systems",
    "Self-Regulation Planning",
    "Emotional Pattern Memory",
    "Negotiation, Conflict & Mediation Systems",
    "Interest-Based Analysis",
    "Post-Conflict Repair",
    "Debate, Argument & Critical Thinking Systems",
    "Fallacy Detection",
    "Steelmanning",
    "Red Team Thinking"
]
...
def validate():
    ...
    if errors:
        ...
        print("PASS: Family batch 065-074 expansion valid.")
        sys.exit(0)
